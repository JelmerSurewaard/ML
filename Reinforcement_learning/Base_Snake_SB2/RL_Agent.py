...
class RL_Agent:
    ...
    def train(self, env, timesteps):
        self.model = DQN("MlpPolicy", env, verbose=1, learning_rate=0.005, gamma=0.99, tensorboard_log="./tensorboard_logs/RLSnake/", exploration_final_eps=self.final_expo_rate)
